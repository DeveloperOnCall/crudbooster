            ...
            foreach ($columns_table as $col) {
                ...
                if (isset($col['image'])) {
                    if ($value == '') {
                        ...
                        $pic = (strpos($value, 'http://') !== false) ? $value : asset('img/'.$value);
    ...
    public function input_assignment($id = null)
    {
        ...
        foreach ($this->data_inputan as $ro) {
            ...
            if (@$ro['type'] == 'filemanager') {
                ...
                $filename = str_replace('/'.config('lfm.files_folder_name').'/', '', $this->arr[$name]);
                $filename = str_replace('/img/uploads/','',$filename);
